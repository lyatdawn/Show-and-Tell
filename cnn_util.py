import caffe
# import ipdb # Single trace! Ipython.
import cv2
import numpy as np
import skimage
...
deploy = '/home/ly/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/home/ly/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
mean = '/home/ly/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
...
class CNN(object):
    ...
    def get_features(self, image_list, layers='fc7', layer_sizes=[4096]):
        ...
        for start, end in zip(range(0, iter_until, self.batch_size), \
            ...
            print("The %d batch size of flickr30K images have done!")%(batch)
            batch+=1
